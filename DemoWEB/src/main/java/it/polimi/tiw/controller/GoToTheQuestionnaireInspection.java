...
@WebServlet("/InspectionQuestionnaire")
public class GoToTheQuestionnaireInspection extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private TemplateEngine templateEngine;
	public GoToTheQuestionnaireInspection() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		templateEngine.process("/WEB-INF/AdminInspectionPage.html", ctx, response.getWriter());
	}
